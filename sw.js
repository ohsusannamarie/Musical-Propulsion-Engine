const CACHE='mpe-v2.2-1';
const ASSETS=['./','./index.html','./manifest.webmanifest','./favicon.svg','./app/payload01.b64','./app/payload02.b64','./app/payload03.b64','./app/payload04.b64','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
